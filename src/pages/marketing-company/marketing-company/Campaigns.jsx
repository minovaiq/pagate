    ...
    <div className="bg-slate-950 border border-slate-800 rounded-lg p-2">
      <div className="flex items-center justify-between mb-2">
        <div>
          ...
          <p className="text-[9px] text-slate-300">إدارة الحملات الترويجية</p>
        </div>
      ...
      {loading ? (
        <div className="text-center py-6 text-[10px] text-slate-300">جاري التحميل...</div>
      ) : campaigns.length === 0 ? (
        <div className="text-center py-6 text-[10px] text-slate-300">لا توجد حملات</div>
      ) : (
            ...
            <div key={item.id} className="bg-slate-900 border border-slate-800 rounded-md p-2">
              <div className="flex items-start justify-between gap-2">
                ...
                <div className="text-left min-w-[80px]">
                  <h2 className="text-xs font-black text-blue-400">
