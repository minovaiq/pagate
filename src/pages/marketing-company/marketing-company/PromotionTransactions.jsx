...
const [promotionType, setPromotionType] = useState("commission");
  ...
  function handleUsdChange(value) {
    ...
    if (usd > 0) {
      setAmount(String(Math.round(usd * USD_RATE)));
    } else {
      setAmount("");
    }
  }
...
const campaignTitle = title.trim() || "تجديد ترويج";
  ...
  return (
    <div className="bg-slate-950 border border-slate-800 rounded-lg p-2">
      ...
      <div className="grid grid-cols-3 gap-1 mb-2">
        ...
        <MiniStat title="الإعلان" value={totalAdSpend} color="text-red-400" />
        <MiniStat title="الربح" value={totalProfit} color="text-blue-400" />
      </div>
  ...
  <option value="net">ترويج صافي</option>
          ...
          <div className="grid grid-cols-4 gap-1">
            ...
            <input
              ...
              className="bg-slate-900 border border-blue-800 rounded-md px-2 h-9 text-[10px] outline-none text-blue-400"
            />
      ...
      {editingClient && canEdit && (
        <div className="bg-slate-900 border border-blue-800 rounded-md p-2 mb-2">
          <div className="grid grid-cols-4 gap-1">
            <input
              value={editName}
          ...
          {groupedClients.map((item) => (
            ...
            >
              ...
              <div className="grid grid-cols-4 gap-1 mb-1">
                <InfoBox
                  title="فيسبوك"
                  value={item.totalAdSpend.toLocaleString()}
                  color="text-red-400"
                />
