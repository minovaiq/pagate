...
export default function Income({
  ...
  async function deleteIncome(item) {
    ...
    await notifyTelegramOperation({
      ...
      action: "delete",
      title: "حذف دخل متجر",
      description: item.title || "دخل متجر",
  ...
  return (
    <div className="bg-slate-950 border border-slate-800 rounded-lg p-2">
      <div className="flex items-center justify-between mb-2">
        <div>
          <h1 className="text-sm font-black">دخل المتجر</h1>
          <p className="text-[9px] text-slate-500">
            مبيعات أو دخل يدوي للمتجر
          </p>
        </div>
      ...
      {canAdd && (
        <form onSubmit={addIncome} className="grid grid-cols-3 gap-1 mb-2">
          <input
            value={title}
          ...
          {items.map((item) => (
            ...
            >
              ...
              <div className="text-left">
                <h2 className="text-[10px] font-black text-green-400">
